...
Design of a 500W Push-Pull Converter Operating in Continuous Conduction Mode (CCM) with
...
\begin{equation}
I_{\text{p\_avg}} = \frac{P_{\text{in}}}{2 \cdot V_{\text{in}}} = \frac{555.56}{2 \cdot 310} = \boxed{\SI{0.896}{\ampere}}
\end{equation}

\subsubsection*{Primary Ripple Current (\(\Delta I_{\text{p}}\))}
\begin{equation}
\Delta I_{\text{p}} = \text{Ripple\_I} \cdot I_{\text{p\_avg}} = 0.3 \cdot 0.896 = \boxed{\SI{0.269}{\ampere}}
\end{equation}

\subsubsection*{Primary Inductance (\(L_p\))}
\begin{equation}
L_p = \frac{V_{\text{in}} \cdot D \cdot (1/F_{\text{sw}})}{\Delta I_{\text{p}}} = \frac{310 \cdot 0.3 \cdot (1/100\text{e}3)}{0.269} = \boxed{\SI{3.46}{\milli\henry}}
\end{equation}

\subsubsection*{Secondary Inductance (\(L_s\))}
\begin{equation}
L_s = \frac{L_p}{T^2} = \frac{3.46 \cdot 10^{-3}}{(7.15)^2} = \boxed{\SI{67.6}{\micro\henry}}
\end{equation}
...
\begin{equation}
\Delta I_{\text{out}} = \text{Ripple\_I} \cdot I_{\text{out}} = 0.3 \cdot 20.83 = \boxed{\SI{6.25}{\ampere}}
\end{equation}
...
\begin{equation}
L_{\text{out}} = \frac{24 \cdot (1 - 2 \cdot D) \cdot (1/F_{\text{sw}})}{\Delta I_{\text{out}}} = \frac{24 \cdot 0.4 \cdot (1/100\text{e}3)}{6.25} = \boxed{\SI{15.36}{\micro\henry}}
\end{equation}
...
\begin{equation}
C_{\text{out}} = \frac{\Delta I_{\text{out}} \cdot (1/F_{\text{sw}})}{8 \cdot \Delta V_{\text{out}}} = \frac{6.25 \cdot (1/100\text{e}3)}{8 \cdot 0.24} = \boxed{\SI{32.55}{\micro\farad}}
\end{equation}
