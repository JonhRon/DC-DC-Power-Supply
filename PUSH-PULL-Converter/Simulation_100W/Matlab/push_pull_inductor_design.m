...
MPL = 8.97; % Magnetic Path Length [ cm ]
We = 29.4; % Core Weight [ grams ]
MLT = 4.2; % Mean Length Turn [ cm ]
Ac = 0.628; % Iron Core or Cross-Sectional area [ cm^2 ]
Wa = 2.516; % Window Area or Bobbin winding area[ cm^2 ]
Ap = 1.5803; % Core Product [ cm^4 ]
Kgs = 0.0935; % Core Geometry [ cm^5 ]
%% Calculation Stage
